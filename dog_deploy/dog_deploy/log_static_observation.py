#!/usr/bin/env python3
"""Unloaded-observation calibration check (2026-08-12, "front knees tucked in / walking on shins"."""
...
def _standing_absolute_deg(motor_joint_names):
    """STANDING_QPOS_DEG_RAW converted to the ABSOLUTE, belt-decoupled frame."""
...
class LogStaticObservation(Node):
    ...
    def __init__(self):
        ...
        # Same two options, same semantics, as policy_node.py's own params
    ...
    def _on_positions_read(self, future):
        ...
        # Same home-relative, sign-corrected convention as policy_node.py's own observation build
        motor_qpos_deg = [
